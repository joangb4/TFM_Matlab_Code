function ode = modelo_mpc
    % MODELO_MPC - Modelo dinámico del sistema para MPC
    %
    % Descripción:
    ...
    % Cálculo de caudales volumétricos basado en aperturas de válvula 1 y 2
    Q_1_Lmin = 0.00195*a_v_1^2 - 0.023*a_v_1;   % [L/min]
    ...
    % UA = f(G_2, w_vent) - Correlación empírica [kW/°C]
